...
| 2026-07-27 | **Item 4 (เหตุการณ์ที่ 2) ยังไม่เสร็จ** — ~~pipeline ผูกกับเหตุการณ์เดียว~~ (แก้แล้ว: `EVENT_ID` env) | **ตัวติดจริงคือข้อมูล**: พื้นที่ท่วมรายจังหวัด 2564 เป็นข้อความบรรยาย ไม่มีตารางครบ (ต่างจาก 2565) | ทำ event-parameterize เสร็จแล้ว (เพิ่ม event = วางไฟล์ `*_{year}.json`); รอข้อมูล 2564 ครบ (ขอ GISTDA/รัน `sentinel1_flood_extent.py` เอง) | **ใช่** — generalization ยังพิสูจน์ไม่ได้ (ยัง 1 เหตุการณ์) |
